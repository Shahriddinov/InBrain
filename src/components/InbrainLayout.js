...
// import {Accor    dion, AccordionHeader, AccordionItem} from "react-bootstrap";
...
const InbrainLayout = (props) => {
    ...
    useEffect(() => {
        axios.get('https://inbarinn.herokuapp.com/user/getData',{
            headers: {
                Authorization: localStorage.getItem("token"),
            },
        }).then((response)=>{
            // console.log(response.data.data)
            getAvatar(response.data.data)
        }).catch((error)=>{
            console.error("error !")
        })
    }, []);
                                    ...
                                    <Typography className="actitle p-0 m-0">
                                        <div className="d-flex align-items-center avatarDiv">
                                            <div className="avatar">
                                                <img src={avatar.user_id}/>
                                            </div>

                                            <div className="ml-3">
                                                            <p className="m-0 p-0">{avatar.user_name}</p>
                                        ...
                                        <Accordion className="accordionMenu">
                                            ...
                                            <AccordionDetails>
                                                <Typography>
                                                    ...
                                                    <Link to="/course_html1" className="text-decoration-none">Базовые
                                                        элементы HTML</Link>
                                                </Typography>
                                            </AccordionDetails>
                                        </Accordion>

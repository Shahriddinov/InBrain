...
const StudentCard = (props) => {
    ...
    // https://inbarinn.herokuapp.com/getContact
    const [avatar, getAvatar] = useState([]);
    useEffect(() => {
        axios.get('https://inbarinn.herokuapp.com/getDo_web_developer',{
            headers: {
                                                ...
                                                <div className="studentCardbuttons">
                                                    <div className="">
                                                        <button className="border-0 btn rounded-0 w-100">
                                                            <Link to="/CourseHtml1" className="buttonlink1">Начать
                                                                обучение<img

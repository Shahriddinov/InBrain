            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-12 d-flex justify-content-between align-items-center mb-4 mt-3">
                        <Link to="/CouseStartone" className="courseStartoneLink"><img src="./imagess/lestbutton.png"/>Вернутся к списску уроков</Link>
                        <Link to="/CourseYou" className="courseStartoneLink">Вперед<img src="./imagess/Vector.png"/></Link>
                    </div>
                </div>
                {/*<Footer/>*/}
            </div>

...
import CourseStarttwo from "./CourseStarttwo";
                    ...
                    <div className="row">
                        ...
                        <div className="col-6 position-relative radioCheck">
                            <img src="./imagess/Group 33107.png" className="position-absolute"
                                 style={{top:"-20px",right:"20px",width:"70%"}} alt=""/>
                        </div>
                        <div className="col-12 d-flex justify-content-between align-items-center mb-4 mt-3">
                            ...
                            <Link to="/CourseStarttwo" className="courseStartoneLink">Вперед<img src="./imagess/Vector.png"/></Link>
                        </div>
                    </div>
                </div>
